...
Graphical user interface - lets us interact with graphical representation of file systems.

- What does CLI stand for?
Commnand Line Interface - commands you type directly to interact 

- Why is it important that developers use the CLI instead of the GUI?
It can be faster when we get gud;
Help us interact and troubleshoot with programs;
NPM - future stuff - This must be done via the CLI;

- "Your computer's filesystem is structured like a tree." What does this statement mean?
We have a main trunk - that evertything branches off of;

- What is the difference between a directory and a file?
Directories - hold our files; Directories can also hold other directories;
...
- Open a new terminal window and then type the following command: `pwd`. Then, hit enter.
  ...
  What is displayed?
  Our path and current working directory

- What does `pwd` stand for?
Prtin working directory
...
Default terminal directory and we go there by cd ~;
